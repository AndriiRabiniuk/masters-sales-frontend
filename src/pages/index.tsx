            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="#" className="hover:text-white transition-colors cursor-pointer">Train</a></li>
                  <li><a href="#" className="hover:text-white transition-colors cursor-pointer">RMK6</a></li>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="#" className="hover:text-white transition-colors cursor-pointer">Components</a></li>
